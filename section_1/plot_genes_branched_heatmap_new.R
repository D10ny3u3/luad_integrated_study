# ref https://github.com/cole-trapnell-lab/monocle-release/issues/509

plot_genes_branched_heatmap_new <- function (cds_subset, branch_point = 1, branch_states = NULL, 
...
{
  cds <- NA
  new_cds <- buildBranchCellDataSet_new(cds_subset, branch_states = branch_states, 
